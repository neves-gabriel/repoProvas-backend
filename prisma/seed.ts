...
async function seed() {
  ...
  await prisma.test.upsert({
    ...
    create: {
      ...
      pdfUrl:
        "https://www.respondeai.com.br/conteudo/fisica/cinematica-retilinea",
      categoryId: 1,
  ...
  await prisma.test.upsert({
    ...
    create: {
      ...
      pdfUrl:
        "https://www.respondeai.com.br/conteudo/algebra-linear-e-geometria-analitica/produto-interno",
      categoryId: 2,
